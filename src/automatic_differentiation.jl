...
# Vec
@inline function _extract{D <: Dual}(v::Vec{1, D})
    @inbounds begin
        p1 = partials(v[1])
        d = Tensor{2, 1}((p1[1],))
    end
...
@inline function _extract{D <: Dual}(v::Vec{2, D})
    @inbounds begin
        p1 = partials(v[1])
        p2 = partials(v[2])
...
@inline function _extract{D <: Dual}(v::Vec{3, D})
    @inbounds begin
        p1 = partials(v[1])
        p2 = partials(v[2])
        p3 = partials(v[3])
...
# Second order tensor
@inline function _extract{D <: Dual}(v::Tensor{2, 1, D})
    @inbounds begin
        p1 = partials(v[1,1])
        d = Tensor{4, 1}((p1[1],))
    end
...
@inline function _extract{D <: Dual}(v::Tensor{2, 2, D})
    @inbounds begin
        p1 = partials(v[1,1])
        p2 = partials(v[2,1])
        p3 = partials(v[1,2])
...
@inline function _extract{D <: Dual}(v::Tensor{2, 3, D})
    @inbounds begin
        p1 = partials(v[1,1])
        p2 = partials(v[2,1])
        p3 = partials(v[3,1])
